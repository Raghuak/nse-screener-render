...
nano ui/app.py import streamlit as st from sqlalchemy import 
create_engine

st.set_page_config(page_title="NSE Top 10", page_icon="📊", 
...
>>>>>>> c7f39c0 (Save local changes before rebase)
# --- Watchlist ---
st.subheader("Watchlist")
cols_watch = [c for c in ["ticker","company","reason","price","rsi14","ema20","vwap","note"] if c in watch.columns]
if cols_watch:
